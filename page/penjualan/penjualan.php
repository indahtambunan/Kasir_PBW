                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="?page=penjualan&aksi=tambah&id=<?php echo $data['id']?>&kode_pj=<?php echo $data['kode_penjualan'] ?>&harga_jual=<?php echo $data['harga_jual']?>&kode_b=<?php echo $data['kode_barcode'] ?>" title="tambah" class="btn btn-success" ><i class="material-icons" data-toggle="tooltip" data-placement="top" title="Tambah">add</i></a>

                                    <a href="?page=penjualan&aksi=kurang&id=<?php echo $data['id']?>&kode_pj=<?php echo $data['kode_penjualan'] ?>&harga_jual=<?php echo $data['harga_jual']?>&kode_b=<?php echo $data['kode_barcode'] ?>" title="kurang" class="btn btn-success" ><i class="material-icons" data-toggle="tooltip" data-placement="top" title="Kurang">remove</i></a>

                                    <a onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?')" href="?page=penjualan&aksi=hapus&id=<?php echo $data['id']?>&kode_pj=<?php echo $data['kode_penjualan'] ?>&harga_jual=<?php echo $data['harga_jual']?>&kode_b=<?php echo $data['kode_barcode']?>&jumlah=<?php echo $data['jumlah']; ?>" title="hapus" class="btn btn-danger" ><i class="material-icons" data-toggle="tooltip" data-placement="top" title="Hapus">clear</i></a>
